...
struct InstanceData {
    glm::vec3 position;
    glm::vec3 rotation;   // Euler angles or axis?angle
    glm::vec3 scale;
    ...
    static std::array<VkVertexInputAttributeDescription, 3> getAttributeDescriptions() {
        ...
        attribs[0].binding = 1;   // same binding as above
        attribs[0].location = 3;   // locations 0‑2 are used by the mesh
...
private:
    ...
    void createParticlePipeline() {
        ...
        /* ---- Push?constant for particle model matrix ----------------------- */
        VkPushConstantRange particlePush{};
        particlePush.stageFlags = VK_SHADER_STAGE_VERTEX_BIT;
        particlePush.offset = 0;
        particlePush.size = sizeof(glm::mat4);

        /* ---- Pipeline layout (reuse the graphics descriptor set layout) ---- */
        VkPipelineLayoutCreateInfo layoutInfo{};
        layoutInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO;
        layoutInfo.setLayoutCount = 1;
        layoutInfo.pSetLayouts = &descriptorSetLayout;   // same as graphics
        layoutInfo.pushConstantRangeCount = 1;
        layoutInfo.pPushConstantRanges = &particlePush;
        ...
        /* ---- Vertex input (no attributes – we use the SSBO as vertex buffer) */
        ...
        pipelineInfo.pStages = stages;  // only vertex + fragment
        ...
        if (vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineInfo, nullptr, &particlePipeline) != VK_SUCCESS) {
    ...
    void createGraphicsPipeline() {
        ...
        VkPipelineLayoutCreateInfo pipelineLayoutInfo{};
        pipelineLayoutInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO;
        pipelineLayoutInfo.setLayoutCount = 1;                    // was 0
        pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout;    // add this
        pipelineLayoutInfo.pushConstantRangeCount = 1;
